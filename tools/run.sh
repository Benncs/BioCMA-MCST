...
flowmap=/home_pers/casale/Documents/thesis/cfd/sanofi/

# flowmap=/home_pers/casale/Documents/code/biomc/cma_data/0d_gas/
# arg_flow=-f $flowmap

args=" -f $flowmap -d 1.0 -np 5000000 -dt 0.001 -er bench2 -mn model_twometa -nt 1 -force 1"
...
mpirun --report-bindings  --bind-to core:overload-allowed --map-by slot:PE=1  \
         -np 1 $executable_gpu $args  --kokkos-num-threads=1 : \
         -np 5 $executable_cpu $args --kokkos-num-threads=1 : \
