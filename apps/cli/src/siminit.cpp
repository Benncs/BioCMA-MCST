...
//  * initialized state.
//  */
// static CmaRead::ReactorState const *init_state(Core::SimulationParameters &params,
...
//   // workers
//   transitioner = std::make_unique<Simulation::FlowMapTransitioner>(params.n_different_maps,
...
//     params.d_t = (params.user_params.delta_time == 0.) ? _flow_handle->MinLiquidResidenceTime() / 100.
