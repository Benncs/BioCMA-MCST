...
#include <biocma_cst_config.hpp> // IWYU pragma: keep
#include <sstream>
#include <streambuf>
/**
 ...
 * restore it later.
 */
int redirect_stdout(std::streambuf*& original_buffer, std::stringstream& variable_stream);
...
#define REDIRECT_SCOPE(__block__) /*NOLINT*/                                                       \
