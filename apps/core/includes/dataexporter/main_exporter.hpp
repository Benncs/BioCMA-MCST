...
{
  /**
   * @brief Exporter for host-only data related to general-purpose simulation
   * data (e.g., concentration, parameters, and other global data).
   *
   * This class is responsible for exporting simulation data at both the initial
   * and final stages, as well as for managing field updates during the
  ...
  public:
     ...
     * @param distribution Initial distribution of particles or entities across
     * compartments.
     */
     ...
     *
     * @param simulation Reference to the simulation unit containing final state
     * information.
     ...
     * @param is_two_phase_flow Flag indicating if the simulation involves
     * two-phase flow.
     */
     ...
     * @param concentration_liquid A span of doubles representing liquid phase
     * concentrations.
     * @param liquid_volume A span of doubles representing liquid phase volumes.
     * @param concentration_gas Optional span of doubles for gas phase
     * concentrations.
