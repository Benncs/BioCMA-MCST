...
namespace Core
{
   ...
   * (e.g., SIGUSR1 and SIGUSR2) during the runtime of the application. It
  ...
  public:
     ...
     *
     * Sets up the signal handlers for SIGUSR1 and SIGUSR2. Throws a runtime
     * error if more than one instance of SignalHandler is created.
     */
  ...
  private:
     ...
     *
     * This static function is called when the SIGUSR1 signal is raised. It sets
     * the internal flag to indicate the signal was received.
     *
     ...
     *
     * This static function is intended to handle the SIGUSR2 signal.
    ...
    bool f_usr1_raised; ///< Flag to indicate if the SIGUSR1 signal was
                        ///< triggered.
    bool f_usr2_raised;
    static SignalHandler*
        instance; ///< Singleton instance of the SignalHandler.
  };
