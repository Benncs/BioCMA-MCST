...
[[nodiscard]] double
HostImportantLoadBalancer::getRatio(uint64_t n, uint32_t rank) const noexcept
{
  (void)n;
...
BoundLoadBalancer::BoundLoadBalancer(uint32_t s, uint64_t _n_max)
    : ILoadBalancer(s), n_max(_n_max)
{
}
