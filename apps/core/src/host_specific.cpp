...
namespace
{
  static IO::ProgressBar progressbar = IO::ProgressBar();
  ...
  void pre_post_export(
      ...
      const std::unique_ptr<Core::MainExporter>& main_exporter,
...
namespace
{
                 ...
                 Core::PartialExporter& partial_exporter)
  {
    ...
    if (do_export)
    {
      pre_post_export(current_time, main_exporter, simulation, transitioner);
    }
