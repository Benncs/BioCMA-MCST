...
namespace Core
{
  ...
  OptionalPtr<MC::MonteCarloUnit> GlobalInitialiser::init_monte_carlo()
  {
    ...
    auto mc_unit = AutoGenerated::wrap_init_model_selector(logger,
        i_model,
  ...
  GlobalInitialiser::init_transitionner(std::unique_ptr<CmaRead::FlowIterator>&& flow_handle)
  {
    ...
    // workers
    auto transitioner = CmaUtils::get_transitioner(logger,CmaUtils::FlowmapTransitionMethod::Discontinuous,
