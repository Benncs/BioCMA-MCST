...
namespace Core
{
  ...
  OptionalPtr<MC::MonteCarloUnit> GlobalInitialiser::init_monte_carlo()
  {
    ...
    auto mc_unit =
        AutoGenerated::wrap_init_model_selector(i_model,
                                                info,
                                                user_params.number_particle,
                                                liquid_volume,
                                                liquid_neighbors,
                                                user_params.biomass_initial_concentration,total_mass);
  ...
  GlobalInitialiser::init_transitionner(std::unique_ptr<CmaRead::FlowIterator>&& flow_handle)
  {
    ...
    // workers
    auto transitioner = std::make_unique<Simulation::FlowMapTransitioner>(
