...
namespace MC
{
  ...
  struct MonteCarloUnit
  {
    ...
    AutoGenerated::ContainerVariant container; ///< Variant container holding various simulation entities
    ...
    SET_NON_COPYABLE(MonteCarloUnit)    ///< Prevent copying of the MonteCarloUnit
    SET_DEFAULT_MOVABLE(MonteCarloUnit) ///< Allow moving of the MonteCarloUnit
