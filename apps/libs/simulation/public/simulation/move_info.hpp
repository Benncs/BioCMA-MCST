...
namespace Simulation::KernelInline
{
  ...
  //     this->liquid_volume.extent(0)); const auto n_c = diag.size(); const
  //     auto n_neighbors = proba.size() / n_c; KOKKOS_ASSERT(proba.size() % n_c
  //     == 0);
  ...
  //   void
  //   set_flow(const std::size_t i, const std::size_t i_flow, const double
  //   flow)
  //   {
