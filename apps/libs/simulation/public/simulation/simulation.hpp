...
namespace Simulation
{
  ...
  public:
    ...
    void ode_step(double d_t) const;
    void clearContribution() const noexcept;
    void update_feed(double d_t, bool update_scalar = true) noexcept;

    double advance(double d_t) noexcept;
  ...
  private:
    ...
    // Attributes
    Simulation::Feed::SimulationFeed m_feed;
    ...
    MassTransfer::MassTransferModel m_mt_model;
