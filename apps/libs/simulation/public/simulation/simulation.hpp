...
namespace Simulation
{
  ...
  public:
    ...
    void update(CmaUtils::PreCalculatedHydroState* _flows_l,
  ...
  private:
    ...
    CmaUtils::PreCalculatedHydroState* flow_liquid; // TODO OPTI
    CmaUtils::PreCalculatedHydroState* flow_gas;    // TODO OPTI
  ...
  inline void SimulationUnit::setLiquidFlow(CmaUtils::PreCalculatedHydroState* _flows_l)
  {
    flow_liquid = _flows_l;
  }

  inline void SimulationUnit::setGasFlow(CmaUtils::PreCalculatedHydroState* _flows_g)
  {
    flow_gas = _flows_g;
  }
