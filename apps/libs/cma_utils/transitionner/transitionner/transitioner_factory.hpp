...
namespace CmaUtils
{
   ...
   *
   * Creates and returns a unique pointer to a FlowMapTransitionner based on the
   * provided method and configuration parameters.
   ...
   * @param is_two_phase_flow Boolean flag indicating whether the flow is
   * two-phase.
