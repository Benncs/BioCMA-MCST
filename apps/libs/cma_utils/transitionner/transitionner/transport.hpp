...
namespace CmaUtils
{
   ...
   * likelihood of moving to different compartments. This is by construction
   * non-strictly increasing over rows
   *
   ...
   *
   * Converts a flow map read from the CmaRead private library into
   * FlowMatrixType, a public typedef.
