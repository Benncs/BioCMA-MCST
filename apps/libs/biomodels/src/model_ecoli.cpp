...
// namespace Models
// {
//   KOKKOS_FUNCTION void Ecoli::init(MC::ParticleDataHolder& p, MC::KPRNG _rng)
//   {
...
//     this->nu = nu_max; // Kokkos::max(generator.normal(nu_max / 2., nu_max / 2. / 5.), 0.) / lenght;
//     _rng.random_pool.free_state(generator);
//   }

//   KOKKOS_FUNCTION void Ecoli::metabolism()
//   {
...
//     constexpr double y2_b = (Yields::Y_EG + Yields::Yo_EG) / (Yields::Y_EG * Yields::Y_OG);  // G/O //To modify divide by YO_EG not Y_Eg
...
//     constexpr double y2_e = (Yields::Y_EA + Yields::Yo_EA) / (Yields::Yo_EA * Yields::Y_OA); // A/O
//     constexpr double yield_mol_S_O = 1.; // Number of mol of S from mole of O for mode D conversion
...
//     constexpr double y_x_b = Yields::Y_XG * Yields::Yo_EG / (Yields::Y_EG + Yields::Yo_EG); //Y_xg /y1_b
...
//     // Incomin in molee y2_b = (Yields::Y_EG + Yields::Yo_EG) / (Yields::Y_EG * Yields::Y_OG);  // G/O
...
//   KOKKOS_FUNCTION double Ecoli::uptake(const LocalConcentrationView& concentration)
//   {
...
//   KOKKOS_FUNCTION void Ecoli::update(double d_t,
...
//   KOKKOS_FUNCTION Ecoli Ecoli::division(MC::ParticleDataHolder& p, MC::KPRNG _rng)
//   {
...
//   KOKKOS_FUNCTION void Ecoli::contribution(MC::ParticleDataHolder& p,
...
//   [[nodiscard]] KOKKOS_FUNCTION double Ecoli::mass() const noexcept
//   {
//     return factor * lenght;
//   }

//   // // TODO use Kokks unordered map
//   // KOKKOS_FUNCTION model_properties_detail_t Ecoli::get_properties()
//   // {
