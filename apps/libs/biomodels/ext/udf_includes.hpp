...
namespace UnsafeUDF
{
  ...
  struct Loader
  {
    ...
    static void (*contribution_udf)(Models::UserImpl&,MC::ParticleDataHolder& p,
                                          ContributionView& contrib);

    static Models::UserImpl* (*division_udf)(Models::UserImpl&,MC::ParticleDataHolder& p,MC::KPRNG);
