...
namespace AutoGenerated
{
  std::unique_ptr<MC::MonteCarloUnit> wrap_init_model_selector(
      ...
      const MC::NeighborsView<HostSpace>& liquid_neighbors,bool uniform_mc_init,double& total_mass) noexcept
  {
    switch (i_model)
    {
      @SWITCH_BODY@
  ...
  int get_model_index_from_name(std::string_view model_name) noexcept
  {
    ...
    std::cerr << IO::AnsiCode::red<< "[Initializer]: " <<IO::AnsiCode::reset<<   "Model not found, using DefaultModel instead" << std::endl;
    return -2;
  }
