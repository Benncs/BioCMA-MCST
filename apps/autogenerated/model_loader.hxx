...
{
  constexpr int INDEX_DEFAULT_MODEL = -2;
  constexpr int INDEX_PYTHON_MODEL = -1;

  std::unique_ptr<::MC::MonteCarloUnit>
  wrap_init_model_selector(const std::shared_ptr<IO::Logger>& _logger,
                           int i_model,
  ...
  [[nodiscard]] bool request_udf(std::string_view model_name) noexcept;
} // namespace AutoGenerated
