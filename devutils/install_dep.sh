...
if ! sudo apt-get install -y python3-dev python3 python3-pip wget software-properties-common gnupg libomp-dev libopenmpi-dev libeigen3-dev pkg-config ninja-build; then
