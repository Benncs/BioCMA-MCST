...
flag_cmake="-DCMAKE_POSITION_INDEPENDENT_CODE=ON -DCMAKE_CXX_COMPILER=clang++-18 -DKokkos_ARCH_TURING75=ON -DCUDA_ROOT=/usr/local/cuda-12.6/ -DCMAKE_CXX_STANDARD=20 -B . -S .. -DCMAKE_BUILD_TYPE=Release"
