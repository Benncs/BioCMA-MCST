...
The build can be done with the  **udf_build** script, in order to select model user has to: set the model name as: **udf_model** and set the envar : **BIOMC_LIB_UDF** to the absolute .so path. 
